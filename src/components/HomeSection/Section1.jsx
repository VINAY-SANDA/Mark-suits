...
const Section1 = () => {
  return (
    <div className='min-h-screen w-full flex flex-col md:flex-row px-4 md:px-0 pt-2 md:pt-4 pb-8 md:pb-0'>
      <div className='w-full md:w-1/2 flex flex-col justify-center gap-3 md:gap-4 items-start md:pl-20 lg:pl-35'>
