  ...
  return (
    <>
        <div className='min-h-screen w-full px-4 md:px-8 pt-2 md:pt-4 pb-8 flex flex-col items-center '>
         <h1 className='text-4xl text-center p-30'>
              Resume
            </h1>
            ...
            <button className=' flex flex-row gap-2 items-center bg-yellow-200  text-black px-3 py-2 rounded-2xl mt-10 hover:bg-white hover:text-red-500 hover:scale-110'>Resume <RiDownload2Fill/> </button>
            </div>
     </div>
            <Footer/>
